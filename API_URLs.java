...
public class API_URLs {
    ...
    //all API URLs here
    static final String getUserProfileDetailsAPIUrl = "http://192.168.0.112/hrms_app/get_user_profile_details.php";
    static final String getPostStoriesAPIUrl = "http://192.168.0.112/hrms_app/get_posts_stories.php";
    static final String registerNewEmpAPIUrl = "http://192.168.0.112/hrms_app/register_new_emp.php";
    static final String getLeaveTypesAPIUrl = "http://192.168.0.112/hrms_app/get_leave_types.php";
    static final String getDesignationsAPIUrl = "http://192.168.0.112/hrms_app/get_designations.php";
    static final String getEmpNamesAPIUrl = "http://192.168.0.112/hrms_app/get_emp_names.php";
    static final String imgUploadToServerAPIUrl = "http://192.168.0.112/hrms_app/img_upload_to_server.php";
